...
ifeq ($(PORT_TYPE), rt5350)
MYCFLAGS?=-L ../common -llua -Wl,-rpath,/var/alles_app/lib -D__RT5350__
else
MYCFLAGS?=-L ../common -llua -Wl,-rpath,./lib
endif
...
LUAINC_linux = ../lua/src
LUAPREFIX_linux?=./
CDIR_linux?=luasocket
LDIR_linux?=luasocket
